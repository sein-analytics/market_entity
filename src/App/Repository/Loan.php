    ...
    implements SqlManagerTraitInterface, DbalStatementInterface, LoanInterface
{
    ...
    static $table = [
        self::ID_KEY => [self::DATA_TYPE => 'int', self::DATA_DEFAULT => 'NOT NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::POOL_ID_KEY => [self::DATA_TYPE => 'int', self::DATA_DEFAULT => 'NOT NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::STATE_ID_KEY => [self::DATA_TYPE => 'int', self::DATA_DEFAULT => 'NOT NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::MSA_CODE_ID_KEY => [self::DATA_TYPE => 'int', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::AMORT_ID_KEY => [self::DATA_TYPE => 'int', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::DESC_ID_KEY => [self::DATA_TYPE => 'int', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::LOAN_ID_KEY => [self::DATA_TYPE => 'varchar', self::DATA_DEFAULT => 'NOT NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::ORIG_BAL_KEY => [self::DATA_TYPE => 'decimal', self::DATA_DEFAULT => 'NOT NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::CURR_BAL_KEY => [self::DATA_TYPE => 'decimal', self::DATA_DEFAULT => 'NOT NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::MON_PMT_KEY=> [self::DATA_TYPE => 'decimal', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::ISSUE_BAL_KEY => [self::DATA_TYPE => 'decimal', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::INIT_RATE_KEY => [self::DATA_TYPE => 'decimal', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::SEASNING_KEY => [self::DATA_TYPE => 'int', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::CURR_RATE_KEY => [self::DATA_TYPE => 'decimal', self::DATA_DEFAULT => 'NOT NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::ORIG_DATE_KEY => [self::DATA_TYPE => 'datetime', self::DATA_DEFAULT => 'NOT NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::DUE_FOR_DATE_KEY => [self::DATA_TYPE => 'datetime', self::DATA_DEFAULT => 'NOT NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::FST_PAY_DATE => [self::DATA_TYPE => 'datetime', self::DATA_DEFAULT => 'NOT NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::LOAN_STAT_KEY => [self::DATA_TYPE => 'varchar', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::FIN_DUE_DATE_KEY => [self::DATA_TYPE => 'datetime', self::DATA_DEFAULT => 'NOT NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::ORIG_TERM_KEY => [self::DATA_TYPE => ['decimal', 'integer'], self::DATA_DEFAULT => 'NOT NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::REM_TERM_KEY => [self::DATA_TYPE => ['decimal', 'integer'], self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::AMORT_TERM_KEY => [self::DATA_TYPE => ['decimal', 'integer'], self::DATA_DEFAULT => 'NOT NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::IO_TERM_KEY => [self::DATA_TYPE => ['decimal', 'integer'], self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::BALON_TERM_KEY => [self::DATA_TYPE => ['decimal', 'integer'], self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::ORIG_LTV_KEY => [self::DATA_TYPE => 'decimal', self::DATA_DEFAULT => 'NOT NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::ORIG_CLTV_KEY => [self::DATA_TYPE => 'decimal', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::APPR_VAL_KEY => [self::DATA_TYPE => 'decimal', self::DATA_DEFAULT => 'NOT NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::CREDIT_SC_KEY => [self::DATA_TYPE => ['decimal', 'integer'], self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::FRONT_DTI_KEY => [self::DATA_TYPE => 'decimal', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::BACK_DTI_KEY => [self::DATA_TYPE => 'decimal', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::NUM_BORR_KEY => [self::DATA_TYPE => 'int', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::FST_TIMEB_KEY => [self::DATA_TYPE => 'int', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::LIEN_POS_KEY => [self::DATA_TYPE => 'int', self::DATA_DEFAULT => 'NOT NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::NOTE_TYPE_KEY => [self::DATA_TYPE => 'varchar', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::LOAN_TYPE_KEY => [self::DATA_TYPE => 'varchar', self::DATA_DEFAULT => 'NOT NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::DOC_TYPE_KEY => [self::DATA_TYPE => 'varchar', self::DATA_DEFAULT => 'NOT NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::PUR_TYPE_KEY => [self::DATA_TYPE => 'varchar', self::DATA_DEFAULT => 'NOT NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::OCCU_TYPE_KEY => [self::DATA_TYPE => 'varchar', self::DATA_DEFAULT => 'NOT NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::DWELL_TYPE_KEY => [self::DATA_TYPE => 'varchar', self::DATA_DEFAULT => 'NOT NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        //self::ADDR_KEY => [self::DATA_TYPE => 'varchar', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::CITY_KEY => [self::DATA_TYPE => 'varchar', self::DATA_DEFAULT => 'NOT NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::ZIP_KEY => [self::DATA_TYPE => 'varchar', self::DATA_DEFAULT => 'NOT NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::ASST_ATTR_KEY => [self::DATA_TYPE => 'varchar', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::PMT_STR_KEY => [self::DATA_TYPE => 'varchar', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::SVC_FEE_KEY => [self::DATA_TYPE => 'decimal', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::LPMI_FEE_KEY => [self::DATA_TYPE => 'decimal', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::MI_COV_KEY => [self::DATA_TYPE => 'decimal', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::FORC_DATE_KEY => [self::DATA_TYPE => 'decimal', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::BKRY_DATE_KEY => [self::DATA_TYPE => 'decimal', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::REO_DATE_KEY => [self::DATA_TYPE => 'decimal', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::ZERO_BAL_DATE_KEY => [self::DATA_TYPE => 'decimal', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::LOAN_MOD_IND_KEY => [self::DATA_TYPE => 'int', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::END_MOD_PER_KEY => [self::DATA_TYPE => 'datetime', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::CHANNEL_KEY => [self::DATA_TYPE => 'varchar', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::LAST_PMT_DATE_KEY => [self::DATA_TYPE => 'datetime', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::TIMES_30_KEY => [self::DATA_TYPE => 'int', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::TIMES_60_KEY => [self::DATA_TYPE => 'int', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::TIMES_90_KEY => [self::DATA_TYPE => 'int', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::YR_BUILT_KEY => [self::DATA_TYPE => 'int', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::NEW_USED_IND_KEY => [self::DATA_TYPE => 'varchar', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::RESERVES_KEY => [self::DATA_TYPE => 'decimal', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
        self::DEALR_RSVS_KEY => [self::DATA_TYPE => 'decimal', self::DATA_DEFAULT => 'NULL', self::PROP_CATEGORY_KEY =>self::LOANS_TABLE_CATEGORY],
    ...
    private string $fetchLoansByIdsSql = "SELECT l.*, p.deal_id AS dealId FROM loans AS l LEFT JOIN Pool AS p ON p.id = l.pool_id WHERE l.id IN (?);";
