...
class Loan extends EntityRepository implements SqlManagerTraitInterface
{
    ...
    static $table = [
      ...
      'original_term' => [self::DATA_TYPE => ['decimal', 'int'], self::DATA_DEFAULT => 'NOT NULL'],
      'remaining_term' => [self::DATA_TYPE => ['decimal', 'int'], self::DATA_DEFAULT => 'NULL'],
      'amortization_term' => [self::DATA_TYPE => ['decimal', 'int'], self::DATA_DEFAULT => 'NOT NULL'],
      'io_term' => [self::DATA_TYPE => ['decimal', 'int'], self::DATA_DEFAULT => 'NULL'],
      'balloon_period' => [self::DATA_TYPE => ['decimal', 'int'], self::DATA_DEFAULT => 'NULL'],
