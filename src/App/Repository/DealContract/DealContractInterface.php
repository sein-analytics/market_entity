...
interface DealContractInterface
{

    const DC_QRY_ID_KEY = 'id';

    const DC_QRY_CONTRACT_NAME_KEY = 'contract_name';
    ...
    const DC_QRY_DOC_TYPE_ID_KEY = 'doc_type_id';

    const DC_QRY_CONTRACT_SIGNATURE_ID = 'contract_signature_id';
